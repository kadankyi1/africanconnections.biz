...
function setCustomTourDetails(x) {
	if(x.value == "December 2023 Ghana Wedding Tour"){
		...
		document.getElementById("brochue_link_2").href = "/new/brochures/december2023ghanaweddingtour.pdf";
		...
		document.getElementById("brochue_link_2").href = "/new/brochures/harrismayfamilyjuly2024tourbrochure.pdf";
		document.getElementById("contact_us_section").style.display="none";
		document.getElementById("tabs-7").style.display="";
